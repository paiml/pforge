...
const HANDLERS_MOD_TEMPLATE: &str = include_str!("../../../../templates/new-project/src/handlers/mod.rs.template");
const HELLO_RS_TEMPLATE: &str = include_str!("../../../../templates/new-project/src/handlers/hello.rs.template");
